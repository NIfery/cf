package com.it.cf.bootpay;

import com.google.gson.Gson;
import com.it.cf.bootpay.model.request.*;
import com.it.cf.bootpay.model.response.ResToken;
...
//     private final String URL_REMOTE_FORM = BASE_URL + "app/rest/remote_form.json";
    ...
    public void getAccessToken() throws Exception {
        ...
        System.out.println("토큰생성:"+resToken);
        System.out.println("토큰생성:"+resToken.status);
