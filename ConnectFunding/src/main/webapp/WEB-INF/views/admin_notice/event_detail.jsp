						...
						<div class="tab-pane fade show active" id="nav-event" role="tabpanel"
							...
							<fmt:formatDate value="${noticemap['ENDDAY']}" pattern="yyyy-MM-dd" var="endday"/>
								...
								<c:when test="${empty noticemap['NEXT_NO']}">
									<div class="prenext">
										<ul>
											<li>
												<b>이전글</b>
												<a href="<c:url value='/admin_notice/event_detail?noticeNo=${noticemap["PRE_NO"]}'/>"
													style="color: black;">
								...
								<c:when test="${empty noticemap['PRE_NO']}">
									<div class="prenext">
										<ul>
											<li>
												<b>다음글</b>
												<a href="<c:url value='/admin_notice/event_detail?noticeNo=${noticemap["NEXT_NO"]}'/>"
													style="color: black;">
												<span style="margin-left: 15px; margin-top: 15px;">
								...
								<c:if test="${sessionScope.adminPosition=='ADMIN'}">
									<div class="nfoot" style="float: left;">
