				...
				<div class="properties__button">
					...
					<nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
							...
							이벤트</a>
							<a class="nav-item nav-link active" id="nav-news-tab" data-toggle="tab" href="#nav-news"
								role="tab" aria-controls="nav-news" aria-selected="true">
							보도자료</a>
						</div>
					</nav>
					<!--End Nav Button  -->
				...
				<div class="col-12">
					...
					<div class="tab-content" id="nav-tabContent">
						...
						<div class="tab-pane fade show active" id="nav-news" role="tabpanel"
							...
							<form action="<c:url value='/admin_notice/deleteNotice'/>" method="post" name="frmDelete">
								...
								<c:when test="${empty noticemap['NEXT_NO']}">
									<div class="prenext">
										<ul>
											<li>
												<b>이전글</b>
												<a href="<c:url value='/admin_notice/news_detail?noticeNo=${noticemap["PRE_NO"]}'/>"
													style="color: black;">
								...
								<c:when test="${empty noticemap['PRE_NO']}">
									<div class="prenext">
										<ul>
											<li>
												<b>다음글</b>
												<a href="<c:url value='/admin_notice/news_detail?noticeNo=${noticemap["NEXT_NO"]}'/>"
													style="color: black;">
												<span style="margin-left: 15px; margin-top: 15px;">
								...
								<c:if test="${sessionScope.adminPosition=='ADMIN'}">
									<div class="nfoot">
										<a href="<c:url value='/admin_notice/notice_edit?noticeNo=${noticemap["NOTICE_NO"]}'/>" 
								...
								<c:if test="${sessionScope.adminPosition!='ADMIN'}">
									<div class="nfoot">
									<a href="<c:url value='/admin_notice/notice_tab'/>" style="margin-right: 450px;"
