		...
		<div class="container">
			...
			<form name="frmWrite" role="form" method="post" enctype="multipart/form-data" action="<c:url value='/board/Edit'/>">
				...
				<div class="mb-3">
					...
					<textarea class="form-control" rows="10" name="boardContent" id="summernote" placeholder="수정 할 내용을 입력해 주세요" >${vo.boardContent }</textarea>
				</div>
				<br>
				<div class="mb-3">
					<label for="tag">업로드파일</label>
					 <c:if test="${!empty FileInfo }">
					 <p>*파일 업로드시 기존 업로드 ( ${vo.boardOldfilename} )는 삭제 됩니다.</p>
					 </c:if>
