...
.genric-btn.primary-border {
	...
	<div class="single_sidebar_widget post_category_widget"
		style="width: 1200px; margin-left: 200px; background: white; height: auto; margin-top: 50px; min-height: 600px;">
				...
				<div class="properties__button">
					...
					<nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
							<a class="nav-item nav-link" id="nav-noticee-tab" data-toggle="tab" 
								href="#nav-noticee" role="tab" aria-controls="nav-noticee" aria-selected="false">
							공지사항</a>
			...
			<div class="row">
				<div class="col-12" style="height: auto;">
					...
					<div class="tab-content" id="nav-tabContent">
						<!-- card one -->
						<div class="tab-pane fade " id="nav-noticee"
							role="tabpanel" aria-labelledby="nav-noticee-tab">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#nav-noticee-tab').click(function(){
			$('#one').load('${pageContext.request.contextPath}/notice/notices');
		});
